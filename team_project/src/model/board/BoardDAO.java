...
public class BoardDAO {
	...
	String sql_selectLikeFiltered = "SELECT BRDCODE, BRDUSERCODE, BRDTITLE, BRDWRITER, BRDCONTENT, TO_CHAR(BRDDATE, 'YYYYMMDD') BRDDATE, BRDVISITED, BRDLIKE, BRDDISLIKE FROM TB_BOARD WHERE BRDLIKE>0 ORDER BY BRDLIKE DESC;";
